...
export const announcementsData = [
    {
        id: "a1",
        title: {
            ar: "جدول الامتحانات النهائية للفصل الدراسي الثاني",
            en: "Final Examinations Schedule - Spring Term",
        },
        date: "2026-05-01",
        type: "Urgent",
        content: {
    ...
    },
    {
        id: "a2",
        title: {
            ar: "فتح باب التسجيل في الدورات التدريبية الصيفية",
            en: "Registration Open for Summer Training Courses",
        },
        date: "2026-06-10",
        type: "General",
        content: {
