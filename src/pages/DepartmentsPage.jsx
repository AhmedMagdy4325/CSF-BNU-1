...
import aiImage from "../assets/AI-1.jpg";
import computationalImage from "../assets/Computational Linguistics.jpg";
import dataScienceImage from "../assets/Data-Science.jpg";
import softwareImage from "../assets/software_engineering.jpg";
import vrImage from "../assets/Virtual and Augmented Reality.jpg";
...
const DepartmentsPage = () => {
    ...
    const departmentImages = {
        "software-engineering": softwareImage,
        "artificial-intelligence": aiImage,
        "data-science": dataScienceImage,
        "computational-linguistics": computationalImage,
        "virtual-reality": vrImage,
    };

    return (
        <div
            dir={isArabic ? "rtl" : "ltr"}
            className="mx-auto max-w-7xl space-y-14 px-4 py-12 sm:px-6 lg:px-8"
        >
            <section className="rounded-4xl bg-[#0b1d2f] px-6 py-12 text-white shadow-[0_30px_60px_rgba(16,39,61,0.22)] sm:px-8 lg:px-10">
                <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                    <div className={isArabic ? "space-y-5 text-right" : "space-y-5 text-left"}>
                        <span className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xm font-black tracking-[0.12em] text-[#14b6d8]">
                    ...
                    <div className="rounded-[28px] border border-white/10 bg-[#11243b] p-6 shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
                        <div className="grid gap-4 sm:grid-cols-2">
                            {[
                                ...
                                >
                                    <div className="text-2xl font-black text-[#d3a85f]">
                                        {item.value}
                                    </div>

                                    <div className="mt-2 text-xm font-bold tracking-[0.08em] text-slate-300">
            ...
            <section className="grid gap-6 md:grid-cols-2">
                {departments.map(department => (
                    ...
                    >
                        <img
                            src={departmentImages[department.id]}
                            alt={department.title[isArabic ? "ar" : "en"]}
                        ...
                        <div className="p-7">
                            ...
                            <p className="text-sm leading-7 text-slate-600">
                                {department.summary[isArabic ? "ar" : "en"]}
                            </p>
                            ...
                            <div className="mt-5 flex flex-wrap gap-2">
                                {department.tags.map(tag => (
                                    <span
                                        key={tag}
                                        className="rounded-full bg-[#eef4f9] px-3 py-1.5 text-[11px] font-black tracking-[0.08em] text-[#10273d]"
                                    >
                                        {tag}
                                    </span>
                                ))}
                            ...
                            <div className="mt-7 flex items-center justify-between border-t border-slate-200 pt-5">
                                <span className="text-xs font-black tracking-[0.12em] text-[#0a9fc1]">
                                ...
                                >
                                    <span>
                                        {isArabic ? "عرض القسم" : "View program"}
                                    </span>
            ...
            <section className="rounded-4xl bg-linear-to-r from-[#10273d] to-[#14b6d8] p-6 text-white shadow-[0_30px_60px_rgba(16,39,61,0.14)] sm:p-8">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div className={isArabic ? "text-right" : "text-left"}>
                        <p className="text-[11px] font-black tracking-[0.12em] text-cyan-100">
